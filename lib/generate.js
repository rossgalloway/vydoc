...
var generateMarkDown = function (contracts, output, templatePath) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, ramda_1.pipe(function (path) {
                ...
                return ejs_1["default"].compile(templateString);
            }, function (template) {
                ...
                return ramda_1.pipe(function (handler) {
                    return contracts
                        ...
                        var dir = path_1.join(output, contract.fileName, '..');
                        console.log('Creating directory:', dir); // Added logging
                        fs_1.mkdirSync(dir, { recursive: true });
                    }))
                        .map(ramda_1.tap(function (contract) {
                        var filePath = path_1.join(output, contract.fileName).replace(/\.[^.]+$/, '.md');
                        ...
                        fs_1.writeFileSync(filePath, template(contract).toString());
                    }))
